...
void 	_cilindro::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	glPushMatrix();
	glTranslatef(0,0,0);
	glRotatef(0,0,0,1);
...
void 	_rueda::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
  ...
  //glTranslatef(-1,-1,-1);
	...
	cilindro1.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();
}
...
void 	_articulaciones::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	glPushMatrix();
  //glTranslatef(-1,-1,-1);
	glRotatef(90,1,0,0);
...
//	glScalef(0.125,0.1,0.125);
	articulaciones.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
	glPopMatrix();
...
void 	_PALA_ARTI2::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, float alfa, float beta, float gama){
	//Brazo2 izq
	glPushMatrix();
...
void 	_PALA_ARTI2_ARTI1::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, float alfa, float beta, float gama){
	//Brazo1 izq
	glPushMatrix();
	...
	pala_arti2.draw(modo, r1, g1, b1, r2, g2, b2, grosor,alfa,beta,gama);
	glPopMatrix();
}
...
void 	_COMPLETO::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	glPushMatrix();
	glTranslatef(0,0,0);
	glScalef(1,1,1);
	...
	pala_arti2_base.draw(modo, r1, g1, b1, r2, g2, b2, grosor,alfa,beta,gama);
	glPopMatrix();
	//__________________________________
