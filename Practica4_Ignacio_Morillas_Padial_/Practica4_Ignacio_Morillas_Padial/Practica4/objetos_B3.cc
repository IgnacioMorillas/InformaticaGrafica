...
void 	_PALA_ARTI2::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, float alfa, float beta, float gama,int material){
	//Brazo2 izq
	glPushMatrix();
	glTranslatef(0,0,1.05);
	glScalef(1,1,1);

	brazos.draw(modo, r1, g1, b1, r2, g2, b2, grosor,material);
	glPopMatrix();
	//Brazo2 izq
	glPushMatrix();
	glTranslatef(0,0,-1.05);
	...
	pala.draw(modo, r1, g1, b1, r2, g2, b2, grosor,material);
	glPopMatrix();
}
...
void 	_PALA_ARTI2_ARTI1::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor, float alfa, float beta, float gama,int material){
	//Brazo1 izq
	glPushMatrix();
	...
	pala_arti2.draw(modo, r1, g1, b1, r2, g2, b2, grosor,alfa,beta,gama, material);
	glPopMatrix();
}
...
void 	_base::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor,int material){
...
void 	_COMPLETO::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor,int material){
	glPushMatrix();
	glTranslatef(0,0,0);
	glScalef(1,1,1);
	...
	pala_arti2_base.draw(modo, r1, g1, b1, r2, g2, b2, grosor,alfa,beta,gama,material);
	glPopMatrix();
	//__________________________________
